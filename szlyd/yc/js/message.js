! function(n) {
    ...
    e.m = n, e.c = t, e.d = function(n, t, i) {
        ...
        if (e.r(i), Object.defineProperty(i, "default", {
            ...
            for (var a in n) e.d(i, a, function(t) {
                return n[t]
            }.bind(null, a));
        return i
    }, e.n = function(n) {
    ...
    function o(n) {
        ...
        function e(e) {
            return function(o) {
                "string" == typeof o && (o = {
                    content: o
                }), !1 === o.title && o.title, o.type = e;
                var r = t.createElement("div");
                r.className = "ui__alert", r.innerHTML = a.a;
                var s = '<h4 class="ui__title">'.concat(o.title || n.alertTitle || "温馨提示", "</h4>");
                s += "<div>".concat(o.content, "</div>");
                var u = '<a href="javascript:;" class="btn_done download download_btn">'.concat(o.doneText || "确认", "</a>");
    ...
    function b(n, t) {
        ...
        var i = c[c.length - 1];
        if ("top" === n.insertAt) i ? i.nextSibling ? e.insertBefore(t, i.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild), c.push(t);
