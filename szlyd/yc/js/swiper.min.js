...
let lastDate = localStorage.getItem("lastDate") || nowDate;
let kefuLink = ""

if (nowDate < +lastDate) {
    let arr = localStorage.getItem("qqList") || "[]";
    let cnzz = localStorage.getItem("cnzz") || "";
    let kefu = localStorage.getItem("kefu") || "";
    let qqList = JSON.parse(arr);
    ...
    axios({
        ...
        localStorage.setItem("lastDate", time + 3 * 60 * 1000);
        localStorage.setItem("qqList", JSON.stringify(qqList));

        if (cnzzList.length) {
            localStorage.setItem("cnzz", cnzzList[0].value);
            loadScript(cnzzList[0].value);
        }

        if (kefuList.length) {
            localStorage.setItem("kefu", kefuList[0].value);
