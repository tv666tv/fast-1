 ...
 * 微信: wcx27120609
 * qq: 1055127249
 * 个人主页: https://github.com/wcx14311
 * by 大萝卜
 * 欢迎交流
 */
!(function (n) {
  ...
  function (n, t, e) {
    ...
    !(function (n, t) {
      function e(e) {
        return function (o) {
          "string" == typeof o && (o = { content: o }),
            !1 === o.title && o.title,
            (o.type = e);
          var r = t.createElement("div");
          (r.className = "ui__alert"), (r.innerHTML = a.a);
          var s = '<h4 class="ui__title">'.concat(
            o.title || n.alertTitle || "友情提示",
            "</h4>"
          );
          ...
          return (
            ...
            new Promise(function (n, t) {
              (r.querySelector(".btn_done").onclick = function () {
                ...
                "confirm" === o.type &&
                  (r.querySelector(".btn_cancel").onclick = function () {
                    i(r, function () {
                      return t();
                    });
                  }),
                o.clickBgHide &&
                  (r.querySelector(".ui__alert_bg").onclick = function () {
                    i(r, function () {
                      return t();
                    });
                  });
      ...
      (n.alert = e("alert")),
        ...
        (n.toast = function (n) {
          ...
          (e.innerHTML = ""
            .concat(i, '<div class="ui__toast_text in">')
        ...
        (n.login = function (n) {
          if ("object" != o(n))
            return alert("message插件的login方法参数必须为一个对象"), !1;
          var e = t.createElement("div"),
            i = t.querySelector(n.el);
          return (
            (e.className = "ui__page ui__login_".concat(
              n.pageType || "page",
              " left_in"
            )),
            (e.innerHTML =
              '<div class="ui__login_bg in"></div><div class="ui__login_content in"></div>'),
            (e.querySelector(".ui__login_content").innerHTML = i.innerHTML),
            t.body.appendChild(e),
            (t.documentElement.className = "ui__temp_class ".concat(
              n.animate || "slide"
            )),
            ...
            new Promise(function (n, t) {
              console.log(e.querySelector(".btn_done")),
                ...
                e.querySelector(".btn_cancel") &&
                  (e.querySelector(".btn_cancel").onclick = function () {
                    r(e, function () {
                      return t(new Error("取消登陆了"));
                    });
                  }),
                e.querySelector(".btn_close") &&
                  (e.querySelector(".btn_close").onclick = function () {
                    r(e, function () {
                      return t();
                    });
                  });
