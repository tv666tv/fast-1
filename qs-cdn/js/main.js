...
let kefuServer = document.querySelector(".kefu-server");
let qq1 = document.querySelector(".qq1");
let download = document.querySelector(".download");

kefuServer.addEventListener("click", () => {
  if (kefuLink) {
...
function wakeQQ() {
  alert({
    title: "添加账号联系",
    content: "安装好专用APP后，请添加小妹账号:" + currentQq,
    doneText: "确定",
  }).then(() => {
    if(isAndroid){
      ...
      location.href = iosLink || "https://down.a51fan.com:8146/KSmW.app";
    }
  });
  copy()
}
